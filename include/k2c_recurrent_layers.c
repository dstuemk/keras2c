...
void k2c_lstmcell(k2c_float * state, const k2c_float * input, const k2c_tensor* kernel,
    ...
    k2c_float *h_tm1 = &state[0];  // previous memory state
    k2c_float *c_tm1 = &state[units];  // previous carry state
    const size_t outrows = 1;
    const k2c_float * const Wi = &kernel->array[0];
    const k2c_float * const Wf = &kernel->array[in_width*units];
    const k2c_float * const Wc = &kernel->array[2*in_width*units];
    const k2c_float * const Wo = &kernel->array[3*in_width*units];
    const k2c_float * const Ui = &recurrent_kernel->array[0];
    const k2c_float * const Uf = &recurrent_kernel->array[units*units];
    const k2c_float * const Uc = &recurrent_kernel->array[2*units*units];
    const k2c_float * const Uo = &recurrent_kernel->array[3*units*units];
    const k2c_float * const bi = &bias->array[0];
    const k2c_float * const bf = &bias->array[units];
    const k2c_float * const bc = &bias->array[2*units];
    const k2c_float * const bo = &bias->array[3*units];
    k2c_float *xi = &fwork[0];
    k2c_float *xf = &fwork[units];
    k2c_float *xc = &fwork[2*units];
    k2c_float *xo = &fwork[3*units];
    k2c_float *yi = &fwork[4*units];
    k2c_float *yf = &fwork[5*units];
    k2c_float *yc = &fwork[6*units];
    k2c_float *yo = &fwork[7*units];
...
void k2c_simpleRNNcell(k2c_float * state, const k2c_float * input, const k2c_tensor* kernel,
    ...
    const size_t outrows = 1;
    k2c_float *h1 = &fwork[0];
    k2c_float *h2 = &fwork[units];
...
void k2c_grucell(k2c_float * state, const k2c_float * input, const k2c_tensor* kernel,
    ...
    k2c_float *h_tm1 = &state[0];
    const size_t outrows = 1;
    const k2c_float * const Wz = &kernel->array[0];
    const k2c_float * const Wr = &kernel->array[in_width*units];
    const k2c_float * const Wh = &kernel->array[2*in_width*units];
    const k2c_float * const Uz = &recurrent_kernel->array[0];
    const k2c_float * const Ur = &recurrent_kernel->array[units*units];
    const k2c_float * const Uh = &recurrent_kernel->array[2*units*units];
    const k2c_float * const bz = &bias->array[0];
    const k2c_float * const br = &bias->array[units];
    const k2c_float * const bh = &bias->array[2*units];
    const k2c_float * const rbz = &bias->array[3*units];
    const k2c_float * const rbr = &bias->array[4*units];
    const k2c_float * const rbh = &bias->array[5*units];
    k2c_float *xz = &fwork[0];
    k2c_float *xr = &fwork[units];
    k2c_float *xh = &fwork[2*units];
    k2c_float *yz = &fwork[3*units];
    k2c_float *yr = &fwork[4*units];
    k2c_float *yh = &fwork[5*units];
